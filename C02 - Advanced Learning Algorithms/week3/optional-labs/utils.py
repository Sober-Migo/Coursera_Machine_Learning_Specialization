...
####################################################
# def myfunc(mymodel, files, max_degree=10, baseline=None):
...
#             # Create and train the model
#             mymodel.fit(X_train_mapped_scaled, y_train )
#             models.append(mymodel)
#             myweights.append(mymodel.coef_)

#             # Compute the training MSE
#             yhat = mymodel.predict(X_train_mapped_scaled)
#             train_mse = mean_squared_error(y_train, yhat) / 2
#             train_mses.append(train_mse)
...
#             # Compute the cross-validation MSE
#             yhat = mymodel.predict(X_cv_mapped_scaled)
#             cv_mse = mean_squared_error(y_cv, yhat) / 2
#             cv_mses.append(cv_mse)
#     return myweights